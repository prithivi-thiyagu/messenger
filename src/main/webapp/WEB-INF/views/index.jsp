...
function generateOTP(){
    ...
    if(checkPhnum(phone)){
    document.loginForm.action = "${pageContext.request.contextPath}/generateOTP";
...
<body>
<div class="login">
<form name="loginForm" action="loginValidate" method="post">
    
  <input type="text" placeholder="Phone Number" id="username" name="username">   
  <input type="password" placeholder="OTP" id="password" name="otp">  
